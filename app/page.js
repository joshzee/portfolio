  ...
  return (
    ...
    <TransitionEffect />
      ...
      <div className="absolute left-[50%] top-5 translate-x-[-50%] cursor-pointer">
        ...
        <br/><br/>I&apos;m also studying all things DevOps; Including Network, Cloud and Bare Metal Infrastructure, CI/CD, CDNs, Security Best Practices, Network Troubleshooting and more.
