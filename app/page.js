  ...
  return (
    ...
    <TransitionEffect />
      ...
      <div className="absolute left-[50%] top-5 translate-x-[-50%] cursor-pointer">
        ...
        <br/><br/>I&apos;m also studying all things DevOps; Including Network, Cloud and Bare Metal Infrastructure,<br/> CI/CD, CDNs, Security Best Practices, Network Troubleshooting and more.
        <br/> I&apos;ll start journaling my progress when time allows! 🚀
        </h3>
      </div>
      <ParticlesContainer />
      </div>
